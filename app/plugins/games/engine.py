...
from app.plugins.games.session import GameDefinition, GameSession, GameSessionStatus
        ...
        with self._lock:
            ...
            transitioned = session.transition(
                ...
                end_reason=(
                    reason
                    if new_status
                    in {GameSessionStatus.COMPLETED, GameSessionStatus.CANCELED}
                    else None
                ),
            )
