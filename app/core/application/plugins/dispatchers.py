...
from app.core.contracts.plugins import CommandRejected, PluginActivityRequest, QueryFailed
...
class QueryDispatcher:
    ...
    async def dispatch(
        ...
        try:
            ...
            raise QueryFailed(f"Query handler failed {capability}", plugin_id=provider) from error
