...
def test_topic_history_prompt_section_returns_empty_when_topic_history_is_none() -> (
    None
):
...
def test_topic_history_prompt_section_returns_empty_when_topic_history_is_empty() -> (
    None
):
...
def test_topic_history_prompt_section_limits_recent_topic_history_to_five_entries() -> (
    None
):
    topic_history = TopicHistory()
...
def test_topic_history_prompt_section_includes_rotation_hint_when_topic_is_stagnating() -> (
    None
):
    topic_history = TopicHistory()
...
def test_topic_history_prompt_has_no_rotation_hint_without_stagnation() -> None:
    topic_history = TopicHistory()
